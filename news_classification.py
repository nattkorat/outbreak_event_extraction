...
from utils.prompt import classification_prompt_zero_shot


def classify_text(text: str, target_category: list, model: str = 'llama3.2') -> str:
    """
    Classifies the given text into one of the target categories using a zero-shot classification prompt.
    ...
    """
    prompt = classification_prompt_zero_shot(text, target_category)
...
if __name__ == "__main__":
    ...
    example_categories = ["outbreak", "health_promotion", "prevention", "regulation", "case_report", "others"]
    
    predicted_category = classify_text(example_text, example_categories, model="llama3.2")
